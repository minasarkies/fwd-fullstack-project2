            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent()
                        throw new Error(
                            'Unable to get all orders. Error: '.concat(err_1)
                        )
                    case 4:
                        return [2 /*return*/]
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent()
                        throw new Error(
                            'Unable to find orders from user '
                                .concat(userId, '. Error: ')
                                .concat(err_2)
                        )
                    case 4:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [
                            4 /*yield*/,
                            conn.query(sql, [o.status, o.userId]),
                        ]
                    case 2:
                        result = _a.sent()
                        order = result.rows[0]
                    ...
                    case 3:
                        err_3 = _a.sent()
                        throw new Error(
                            'Unable to create order. Error: '.concat(err_3)
                        )
                    case 4:
                        return [2 /*return*/]
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent()
                        throw new Error(
                            'Unable to delete order product '
                                .concat(orderProductId, '. Error: ')
                                .concat(err_6)
                        )
                    case 4:
                        return [2 /*return*/]
