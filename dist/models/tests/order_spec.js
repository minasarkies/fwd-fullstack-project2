...
describe("Order Model", function () {
    ...
    it("CREATE method should add an order", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), status = _a.status, user_id = _a.user_id;
    ...
    it("INDEX method should return a list of all orders", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = (_b.sent())[0], status = _a.status, user_id = _a.user_id;
                    expect({ status: status, user_id: user_id }).toEqual({
                        status: "shipped",
                        user_id: "3",
                    });
    ...
    it("CREATE order product method should add an order with product quantity and product id", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), quantity = _a.quantity, order_id = _a.order_id, product_id = _a.product_id;
                    expect({ quantity: quantity, order_id: order_id, product_id: product_id }).toEqual({
                        quantity: 4,
                        order_id: "2",
                        product_id: "3",
                    });
    ...
    it("DELETE order product method should remove an order product by order product id", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.deleteOrderProduct("3")];
                case 1:
                    result = _a.sent();
                    // @ts-ignore
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderStore.deleteOrderProduct("2")];
                case 1:
                    _a.sent();
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, userStore.delete(userInstance.username)];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
