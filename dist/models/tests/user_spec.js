...
describe('User Model', function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        ]).toEqual([userInstance])
                        return [2 /*return*/]
                }
            })
        })
    })
    it('SHOW method should return a user by username', function () {
        return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('LOGIN method should return a token', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var foundUser, pepperedPassword, validPassword, token, username
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, store.login(userInstance.username)]
                    case 1:
                        foundUser = _a.sent()
                        ...
                        pepperedPassword = ''
                            .concat(userInstancePassword)
                            .concat(BCRYPT_PEPPER)
                        validPassword = bcrypt_1.default.compareSync(
                            pepperedPassword,
                            foundUser.password
                        )
                        ...
                        username = (0, parseJwt_1.parseJwt)(token).username
    ...
    it('DELETE method should delete a user by username', function () {
        return __awaiter(void 0, void 0, void 0, function () {
            var result
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [
                            4 /*yield*/,
                            store.delete(userInstance.username),
                        ]
                    case 1:
                        _a.sent()
                        return [4 /*yield*/, store.show(userInstance.username)]
